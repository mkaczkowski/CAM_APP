        ...
        Crop.prototype = {
            init: function () {
                ...
                var defaultControls = $('<div/>', { 'class' : 'cropControls' })
                    ...
                    .append($('<a/>', { 'class' : 'cropComplete' }).on('click', $.proxy(this.complete, this)))
            ...
            mirror: function() {
                ...
                this.$image.css({
                    '-moz-transform': 'scale('+ this.scale+',1)',
                    '-webkit-transform': 'scale('+ this.scale+',1)'
                });
